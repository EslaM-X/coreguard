...
| **v0.3 — Passport / reputation + risk findings** | ✅ first-pass surface shipped (2026-09-25): integration state machine + unified states · CoreGuard Conformance Suite (CG-CS/1) · **Evidence Passport** machine-readable registry (`npm run ladder:status` / `npm run ladder:passport` / `npm run ladder:dashboard` — scratch `docs/live-integration-and-adoption-ladder-2026-09-25.md`); the **reputation + risk-findings layer stays 📋 designed** |
