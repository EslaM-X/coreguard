...
const suites = ["test/canonicalization", "test/tamper", "test/anchor", "test/p1", "test/p2", "test/evm", "test/provenance", "test/firewall", "test/firewall/attack-lab", "test/firewall/ws1", "test/sdk", "test/independent-verifier", "test/recovery", "test/verifier-c", "test/eol", "test/encoding", "test/conformance/live"];
const files = [];
