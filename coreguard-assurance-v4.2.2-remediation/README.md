...
3. **التحقق من التجميد (مُرتكز على الـcommit)**: `node verification/validate-freeze.mjs release/freeze/freeze-record-4.2.6.json` — يجب أن يطبع `PASS (46/46 MATCH, anchored @ 2e419f76385f)` · الهاشات تُحسب من شجرة الـcommit الحتمية لا من القرص (وضع `--disk` للتشخيص فقط وليس دليلًا) · السجل: [`release/freeze/freeze-record-4.2.6.json`](./release/freeze/freeze-record-4.2.6.json) (27 إصدار + 19 عزل)
