...
|---|---|---|
| Test suite | **927 / 927 pass** | `npm test` (node `--test`) — +3 from `test/delivery/assent-pair.test.js` (assent A/B pair); CI-green on healthy runners (perf-timing assertions are load-sensitive on this Windows dev box: 2 known classes flake under parallel load, green isolated) |
